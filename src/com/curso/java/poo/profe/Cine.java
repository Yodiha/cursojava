...
//		System.out.println(persona1.edad);
		...
		persona1.apellidos=persona1.getApellidos().toUpperCase();
		System.out.println(persona1.getApellidos());
		persona1.correr();
		
		String nombre = Utilidades.datostring("Introduce tu nombre");
		String apellidos = Utilidades.datostring("Introduce tu apellido");
